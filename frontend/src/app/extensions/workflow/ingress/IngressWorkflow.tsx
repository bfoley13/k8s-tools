...
const ingressSteps = [
  ...
  "Define Rules",
  "Select Ingress Location",
  "Select Workflow",
  "Add Ingress Deployment",
  "Confirm",
];
...
export default function IngressWorkflow(props: {
  appState: AppState;
  ...
  function saveIngressYaml() {
    let currentEditorModel: editor.ITextModel | null | undefined =
      editorRef.current?.getModel();
    let currentIngressDef: string =
      currentEditorModel?.getLinesContent().join("\n") || "";
              ...
              {services.map((service, idx) => {
                return (
                  <div key={idx}>
                    <ListItem
                      key={"service-" + idx}
                      onClick={() => selectServices([service])}
                    >
                      <ListItemButton>
                        <ListItemIcon>
                          <Code />
              ...
              >
                ...
                >
                  {chartDirectories.map((directory, idx) => {
                    return (
                      <MenuItem key={idx} value={directory.path}>
                        {directory.path}
                      </MenuItem>
                    );
                  })}
        ...
        >
          ...
          >
            ...
            >
              <ul>
                <li>
                  <span>Service: {selectedServices[0].name}</span>
                </li>
                <li>
                  <span>Ingress Filename: {filename}</span>
                </li>
                <li>
                  <span>Definition Location: {selectedDirectory}</span>
                </li>
              </ul>
            </div>
          </Paper>
